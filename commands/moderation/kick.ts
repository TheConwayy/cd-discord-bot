...
export default {
    category: 'moderation',
    description: 'Kicks a user for the reason defined',
    ...
    options: [
        {
            type: 'USER',
            name: 'user',
            description: 'The user you want to kick [REQUIRED]',
            required: true
        },
        {
            type: 'STRING',
    ...
    callback: async ({ interaction, guild }) => {
        ...
        if (interaction.user.id === userID) return "You can't kick yourself"
...
VALUES (${userID}, ${modID}, "KICK", "${getReason()}", ${epoch});`
